...
<#-- 主体部分 -->
<div class="xs-mainsection xs-main500 clearfix">
    <!-- 无结果主体左侧 -->
    <div class="xs-nrmain">
        <!-- 搜索无结果内容 -->
        <ul class="note">
            <li>上网太久了，倒杯水，</li>
            <li>今天开PARTY，来的朋友太多了</li>
            <li>有点忙不过来，大家别急，<a class="refresh" href="javascript:void(0);" onClick="window.location.reload();return false;">刷新</a>试试，或<a class="refresh" href="http://ebay.xiu.com">回首页</a></li>
            <li>错误代码：500（服务器内部错误）</li>
            <li class="callus">联系我们，给你喊帮手：<span>400-888-4499</span></li>
        </ul>
    </div>
</div>
<#-- CMS页尾 -->
